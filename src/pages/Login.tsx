...
export function Login () {
  ...
  return (
    <Box marginTop={5} component="section" sx={{display: 'flex', gap: 5, flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
      ...
      <Typography marginBottom={2} width="400px" sx={{'@media screen and (max-width:700px)': { fontSize: '1em', width: '80%', textAlign: 'center'} }}>Usa tus credenciales de Strava para iniciar sesión y dar permisos para consultar tus actividades</Typography>
